...
START_POS1="-30,-20"  
START_POS2="45,0"
EXCHANGE_POS1="25,-250"
EXCHANGE_POS2="165,-250"
...
nsplug meta_vehicle.moos targ_$VNAME1.moos -f WARP=$TIME_WARP  \
    ...
    SHOREIP="localhost"   SHORE_LISTEN="9200"                  \
    VTYPE=UUV             EXCHANGE_POS=$EXCHANGE_POS1

nsplug meta_vehicle.moos targ_$VNAME2.moos -f WARP=$TIME_WARP  \
    VNAME=$VNAME2         START_POS=$START_POS2                \
    VPORT="9002"          SHARE_LISTEN="9302"                  \
    SHOREIP="localhost"   SHORE_LISTEN="9200"                  \
    VTYPE=UUV             EXCHANGE_POS=$EXCHANGE_POS2

nsplug meta_vehicle.bhv targ_$VNAME1.bhv -f VNAME=$VNAME1   \
    START_POS=$START_POS1  EXCHANGE_POS=$EXCHANGE_POS1

nsplug meta_vehicle.bhv targ_$VNAME2.bhv -f VNAME=$VNAME2   \
    START_POS=$START_POS2  EXCHANGE_POS=$EXCHANGE_POS2
